...
$signJson = curl.exe -s -X POST "$apiBase/documents/sign" -H "Authorization: Bearer $($login.accessToken)" -H "Accept: application/json" -F "file=@$PWD\tmp-test.pdf" -F "consent=true"
